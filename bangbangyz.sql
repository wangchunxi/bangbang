...
INSERT INTO `bangbang_admin_menu` VALUES ('167', '0', '0', '1', '10000', 'admin', 'edit', 'default', '', '其他', 'gratipay', '');
INSERT INTO `bangbang_admin_menu` VALUES ('168', '167', '1', '1', '10000', 'admin', 'edit', 'index', '', '吃点啥', 'apple ', '');
INSERT INTO `bangbang_admin_menu` VALUES ('169', '0', '0', '1', '10000', 'admin', 'style', 'default', '', '标签管理', 'indent', '');
INSERT INTO `bangbang_admin_menu` VALUES ('170', '169', '1', '1', '10000', 'admin', 'style', 'styleindex', '', '标签列表', '', '');
INSERT INTO `bangbang_admin_menu` VALUES ('171', '0', '2', '1', '10000', 'admin', 'demo', 'default', '', 'demo管理', 'adjust', '');
INSERT INTO `bangbang_admin_menu` VALUES ('172', '171', '1', '1', '10000', 'admin', 'demo', 'listdemo', '', 'demo列表', '', '');
INSERT INTO `bangbang_admin_menu` VALUES ('173', '171', '1', '1', '10000', 'admin', 'demo', 'form', '', 'demo表单', '', '');
...
INSERT INTO `bangbang_auth_rule` VALUES ('167', '1', 'admin', 'admin_url', 'admin/style/default', '', '标签管理', '');
INSERT INTO `bangbang_auth_rule` VALUES ('168', '1', 'admin', 'admin_url', 'admin/style/styleindex', '', '标签列表', '');
INSERT INTO `bangbang_auth_rule` VALUES ('169', '1', 'admin', 'admin_url', 'admin/demo/default', '', 'demo管理', '');
INSERT INTO `bangbang_auth_rule` VALUES ('170', '1', 'admin', 'admin_url', 'admin/demo/listdemo', '', 'demo列表', '');
INSERT INTO `bangbang_auth_rule` VALUES ('171', '1', 'admin', 'admin_url', 'admin/demo/form', '', 'demo表单', '');

-- ----------------------------
-- Table structure for bangbang_binding_tag
-- ----------------------------
DROP TABLE IF EXISTS `bangbang_binding_tag`;
CREATE TABLE `bangbang_binding_tag` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `bindingId` int(11) NOT NULL DEFAULT '0' COMMENT '被绑定的id',
  `tagId` int(11) NOT NULL COMMENT '绑定的标签',
  `createId` int(11) NOT NULL COMMENT '操作人',
  `createTime` int(11) NOT NULL COMMENT '操作时间',
  `binBingType` varchar(255) NOT NULL COMMENT '绑定的类型',
  PRIMARY KEY (`id`),
  KEY `binBingId` (`tagId`,`binBingType`(191),`bindingId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of bangbang_binding_tag
-- ----------------------------
...
-- ----------------------------
-- Table structure for bangbang_edit
-- ----------------------------
DROP TABLE IF EXISTS `bangbang_edit`;
CREATE TABLE `bangbang_edit` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `dishName` varchar(255) NOT NULL COMMENT '菜名',
  `dishUrl` varchar(255) NOT NULL COMMENT '做菜的链接',
  `dishIngredients` varchar(255) NOT NULL COMMENT '要准备的食材',
  `uid` int(10) NOT NULL COMMENT '是哪个用户的',
  `createTime` int(11) NOT NULL COMMENT '生成食谱的时间',
  `preparationTime` int(11) NOT NULL COMMENT '要做的时间',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '0=》废弃，1=>正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of bangbang_edit
-- ----------------------------

-- ----------------------------
-- Table structure for bangbang_edit_config
-- ----------------------------
DROP TABLE IF EXISTS `bangbang_edit_config`;
CREATE TABLE `bangbang_edit_config` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `dayEditNum` int(11) NOT NULL DEFAULT '0' COMMENT '每天吃饭的顿数',
  `editDishNum` int(11) NOT NULL DEFAULT '0' COMMENT '吃菜的数量',
  `DishName` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='吃点啥配置';

-- ----------------------------
-- Records of bangbang_edit_config
-- ----------------------------

-- ----------------------------
-- Table structure for bangbang_effect_picture
-- ----------------------------
DROP TABLE IF EXISTS `bangbang_effect_picture`;
CREATE TABLE `bangbang_effect_picture` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `effectPictureTitle` varchar(255) NOT NULL,
  `Introduction` text,
  `tagIds` varchar(255) NOT NULL DEFAULT '0',
  `createId` int(11) NOT NULL,
  `createTime` int(11) NOT NULL,
  `updateId` int(11) DEFAULT '0',
  `updateTime` int(11) DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '0=>不显示，1=>显示',
  `sort` int(11) NOT NULL DEFAULT '0' COMMENT '排序按降序排序',
  `isRecommend` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1=>推荐，0=>默认',
  `coverPicture` int(11) NOT NULL COMMENT '封面图',
  `viewingCount` int(11) NOT NULL DEFAULT '0' COMMENT '浏览数量',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of bangbang_effect_picture
-- ----------------------------

-- ----------------------------
-- Table structure for bangbang_effect_picture_info
-- ----------------------------
DROP TABLE IF EXISTS `bangbang_effect_picture_info`;
CREATE TABLE `bangbang_effect_picture_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `effectPictureId` int(11) NOT NULL,
...
-- ----------------------------
-- Records of bangbang_effect_picture_info
-- ----------------------------
...
CREATE TABLE `bangbang_order_info` (
  ...
  `orderStatus` tinyint(2) NOT NULL DEFAULT '0' COMMENT '-1=>无效,0=>下单成功,1=>任务进行中,2=>任务完成',
...
-- ----------------------------
-- Table structure for bangbang_order_panoramic_log
-- ----------------------------
DROP TABLE IF EXISTS `bangbang_order_panoramic_log`;
CREATE TABLE `bangbang_order_panoramic_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `orderId` int(11) NOT NULL COMMENT '工单id',
  `createTime` int(11) NOT NULL COMMENT '创建时间',
  `createId` int(11) NOT NULL COMMENT '创建人',
  `Introduction` varchar(255) NOT NULL COMMENT '内容简介',
  `updateId` int(11) DEFAULT NULL COMMENT '修改人',
  `updateTime` int(11) DEFAULT NULL COMMENT '修改时间',
...
-- ----------------------------
-- Table structure for bangbang_pachong
-- ----------------------------
DROP TABLE IF EXISTS `bangbang_pachong`;
CREATE TABLE `bangbang_pachong` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `url` text NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `pidUrl` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of bangbang_pachong
-- ----------------------------
...
INSERT INTO `bangbang_tag` VALUES ('6', '欧美系列', '1', '1529722848', null, null, '0', 'style', '1');
...
INSERT INTO `bangbang_user_handle_log` VALUES ('647', '1', 'Index', 'index', '未设置日志配置', '1528291962', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('648', '1', 'Main', 'index', '未设置日志配置', '1528291963', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('649', '1', 'Index', 'index', '未设置日志配置', '1528378159', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('650', '1', 'Main', 'index', '未设置日志配置', '1528378160', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('651', '1', 'Index', 'index', '未设置日志配置', '1528385615', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('652', '1', 'Main', 'index', '未设置日志配置', '1528385616', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('653', '1', 'Index', 'index', '未设置日志配置', '1529721829', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('654', '1', 'Main', 'index', '未设置日志配置', '1529721830', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('655', '1', 'Menu', 'index', '未设置日志配置', '1529721862', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('656', '1', 'Menu', 'lists', '未设置日志配置', '1529721869', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('657', '1', 'Style', 'styleindex', '未设置日志配置', '1529721901', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('658', '1', 'Style', 'styleindex', '未设置日志配置', '1529721905', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('659', '1', 'Style', 'styleindex', '未设置日志配置', '1529721907', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('660', '1', 'Pattern', 'patternindex', '未设置日志配置', '1529721911', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('661', '1', 'DecorationType', 'decorationindex', '未设置日志配置', '1529721913', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('662', '1', 'Style', 'styleindex', '未设置日志配置', '1529721915', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('663', '1', 'Menu', 'index', '未设置日志配置', '1529721931', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('664', '1', 'Menu', 'add', '未设置日志配置', '1529721935', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('665', '1', 'Menu', 'addpost', '未设置日志配置', '1529722033', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('666', '1', 'Menu', 'index', '未设置日志配置', '1529722036', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('667', '1', 'Index', 'index', '未设置日志配置', '1529722039', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('668', '1', 'Main', 'index', '未设置日志配置', '1529722040', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('669', '1', 'Style', 'default', '未设置日志配置', '1529722043', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('670', '1', 'Menu', 'index', '未设置日志配置', '1529722068', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('671', '1', 'Menu', 'add', '未设置日志配置', '1529722074', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('672', '1', 'Menu', 'addpost', '未设置日志配置', '1529722100', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('673', '1', 'Menu', 'index', '未设置日志配置', '1529722103', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('674', '1', 'Index', 'index', '未设置日志配置', '1529722105', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('675', '1', 'Main', 'index', '未设置日志配置', '1529722106', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('676', '1', 'Style', 'styleindex', '未设置日志配置', '1529722107', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('677', '1', 'Pattern', 'patternindex', '未设置日志配置', '1529722110', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('678', '1', 'DecorationType', 'decorationindex', '未设置日志配置', '1529722112', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('679', '1', 'Style', 'styleindex', '未设置日志配置', '1529722115', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('680', '1', 'Style', 'styleindex', '未设置日志配置', '1529722117', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('681', '1', 'Style', 'styleindex', '未设置日志配置', '1529722176', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('682', '1', 'Style', 'styleindex', '未设置日志配置', '1529722178', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('683', '1', 'Style', 'styleindex', '未设置日志配置', '1529722180', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('684', '1', 'Style', 'styleindex', '未设置日志配置', '1529722182', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('685', '1', 'Pattern', 'patternindex', '未设置日志配置', '1529722280', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('686', '1', 'DecorationType', 'decorationindex', '未设置日志配置', '1529722282', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('687', '1', 'Style', 'styleindex', '未设置日志配置', '1529722287', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('688', '1', 'Style', 'addstyle', '未设置日志配置', '1529722352', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('689', '1', 'Style', 'styleindex', '未设置日志配置', '1529722357', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('690', '1', 'Pattern', 'patternindex', '未设置日志配置', '1529722427', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('691', '1', 'Style', 'styleindex', '未设置日志配置', '1529722430', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('692', '1', 'Style', 'addstyle', '未设置日志配置', '1529722584', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('693', '1', 'Style', 'addstyle', '未设置日志配置', '1529722690', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('694', '1', 'Style', 'addstyle', '未设置日志配置', '1529722738', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('695', '1', 'Style', 'addstyle', '未设置日志配置', '1529722747', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('696', '1', 'Style', 'addstyle', '未设置日志配置', '1529722751', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('697', '1', 'Style', 'addstyle', '未设置日志配置', '1529722764', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('698', '1', 'Style', 'addstyle', '未设置日志配置', '1529722769', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('699', '1', 'Style', 'addstyle', '未设置日志配置', '1529722848', '127.0.0.1', '{\"tagName\":\"\\u6b27\\u7f8e\\u7cfb\\u5217\",\"image\":\"\",\"status\":1,\"type\":\"style\"}', '', '6', 'add');
INSERT INTO `bangbang_user_handle_log` VALUES ('700', '1', 'Style', 'addstyle', '未设置日志配置', '1529722854', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('701', '1', 'Style', 'styleindex', '未设置日志配置', '1529722854', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('702', '1', 'Demo', 'form', '未设置日志配置', '1529722897', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('703', '1', 'Demo', 'listdemo', '未设置日志配置', '1529722906', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('704', '1', 'Demo', 'index', '未设置日志配置', '1529722910', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('705', '1', 'Menu', 'index', '未设置日志配置', '1529722928', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('706', '1', 'Menu', 'add', '未设置日志配置', '1529722931', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('707', '1', 'Menu', 'addpost', '未设置日志配置', '1529722987', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('708', '1', 'Menu', 'index', '未设置日志配置', '1529722990', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('709', '1', 'Menu', 'add', '未设置日志配置', '1529722995', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('710', '1', 'Menu', 'addpost', '未设置日志配置', '1529723031', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('711', '1', 'Menu', 'index', '未设置日志配置', '1529723034', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('712', '1', 'Menu', 'add', '未设置日志配置', '1529723039', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('713', '1', 'Menu', 'addpost', '未设置日志配置', '1529723085', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('714', '1', 'Menu', 'index', '未设置日志配置', '1529723088', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('715', '1', 'Index', 'index', '未设置日志配置', '1529723089', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('716', '1', 'Main', 'index', '未设置日志配置', '1529723090', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('717', '1', 'Demo', 'listdemo', '未设置日志配置', '1529723092', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('718', '1', 'Demo', 'form', '未设置日志配置', '1529723098', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('719', '1', 'Demo', 'form', '未设置日志配置', '1529723126', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('720', '1', 'Demo', 'listdemo', '未设置日志配置', '1529723132', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('721', '1', 'Style', 'styleindex', '未设置日志配置', '1529723143', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('722', '1', 'Style', 'styleindex', '未设置日志配置', '1529723256', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('723', '1', 'Style', 'styleindex', '未设置日志配置', '1529723283', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('724', '1', 'Style', 'index', '未设置日志配置', '1529723294', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('725', '1', 'Style', 'index', '未设置日志配置', '1529723348', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('726', '1', 'Demo', 'createmodel', '未设置日志配置', '1529724039', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('727', '1', 'Demo', 'formmodel', '未设置日志配置', '1529724053', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('728', '1', 'Index', 'index', '未设置日志配置', '1529724254', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('729', '1', 'Main', 'index', '未设置日志配置', '1529724255', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('730', '1', 'Style', 'styleindex', '未设置日志配置', '1529724262', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('731', '1', 'Style', 'styleindex', '未设置日志配置', '1529724280', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('732', '1', 'Style', 'index', '未设置日志配置', '1529724283', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('733', '1', 'Style', 'styleindex', '未设置日志配置', '1529724436', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('734', '1', 'Style', 'addstyle', '未设置日志配置', '1529724438', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('735', '1', 'Pattern', 'patternindex', '未设置日志配置', '1529724442', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('736', '1', 'Pattern', 'addpattern', '未设置日志配置', '1529724444', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('737', '1', 'DecorationType', 'decorationindex', '未设置日志配置', '1529724447', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('738', '1', 'DecorationType', 'adddecorationtype', '未设置日志配置', '1529724450', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('739', '1', 'DecorationType', 'decorationindex', '未设置日志配置', '1529724463', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('740', '1', 'DecorationType', 'decorationindex', '未设置日志配置', '1529724464', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('741', '1', 'Pattern', 'patternindex', '未设置日志配置', '1529724464', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('742', '1', 'Pattern', 'addpattern', '未设置日志配置', '1529724467', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('743', '1', 'DecorationType', 'decorationindex', '未设置日志配置', '1529724471', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('744', '1', 'DecorationType', 'adddecorationtype', '未设置日志配置', '1529724473', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('745', '1', 'DecorationType', 'adddecorationtype', '未设置日志配置', '1529724503', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('746', '1', 'DecorationType', 'adddecorationtype', '未设置日志配置', '1529724524', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('747', '1', 'DecorationType', 'adddecorationtype', '未设置日志配置', '1529724540', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('748', '1', 'Index', 'index', '未设置日志配置', '1529725095', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('749', '1', 'Main', 'index', '未设置日志配置', '1529725097', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('750', '1', 'Style', 'styleindex', '未设置日志配置', '1529725101', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('751', '1', 'Style', 'styleindex', '未设置日志配置', '1529725125', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('752', '1', 'Style', 'styleindex', '未设置日志配置', '1529725200', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('753', '1', 'Style', 'styleindex', '未设置日志配置', '1529725268', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('754', '1', 'Style', 'styleindex', '未设置日志配置', '1529725307', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('755', '1', 'Style', 'styleindex', '未设置日志配置', '1529725312', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('756', '1', 'Style', 'styleindex', '未设置日志配置', '1529725401', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('757', '1', 'Style', 'styleindex', '未设置日志配置', '1529725472', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('758', '1', 'Style', 'styleindex', '未设置日志配置', '1529725480', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('759', '1', 'Style', 'styleindex', '未设置日志配置', '1529725656', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('760', '1', 'Index', 'index', '未设置日志配置', '1529725684', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('761', '1', 'Main', 'index', '未设置日志配置', '1529725685', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('762', '1', 'Order', 'index', '访问工单主页面', '1529725689', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('763', '1', 'Style', 'styleindex', '未设置日志配置', '1529725698', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('764', '1', 'AdminArticle', 'index', '未设置日志配置', '1529725874', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('765', '1', 'Theme', 'index', '未设置日志配置', '1529726051', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('766', '1', 'Theme', 'install', '未设置日志配置', '1529726073', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('767', '1', 'Theme', 'index', '未设置日志配置', '1529726075', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('768', '1', 'Demo', 'listdemo', '未设置日志配置', '1529727253', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('769', '1', 'Demo', 'form', '未设置日志配置', '1529727255', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('770', '1', 'Demo', 'listdemo', '未设置日志配置', '1529727299', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('771', '1', 'Index', 'index', '未设置日志配置', '1529763437', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('772', '1', 'Main', 'index', '未设置日志配置', '1529763438', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('773', '1', 'AdminIndex', 'index', '未设置日志配置', '1529763455', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('774', '1', 'Rbac', 'index', '未设置日志配置', '1529763460', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('775', '1', 'User', 'index', '用户主页面', '1529763474', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('776', '1', 'User', 'edit', '用户修改页面', '1529763479', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('777', '1', 'User', 'index', '用户主页面', '1529763486', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('778', '1', 'Rbac', 'index', '未设置日志配置', '1529763488', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('779', '1', 'User', 'index', '用户主页面', '1529763489', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('780', '1', 'AdminIndex', 'index', '未设置日志配置', '1529763491', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('781', '1', 'Demo', 'formmodel', '未设置日志配置', '1529764151', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('782', '1', 'Demo', 'createmodel', '未设置日志配置', '1529764153', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('783', '1', 'Demo', 'formmodel', '未设置日志配置', '1529764156', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('784', '1', 'Demo', 'createmodel', '未设置日志配置', '1529764167', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('785', '1', 'Demo', 'test', '未设置日志配置', '1529769696', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('786', '1', 'Demo', 'test', '未设置日志配置', '1529769749', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('787', '1', 'Demo', 'test', '未设置日志配置', '1529769770', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('788', '1', 'Demo', 'test', '未设置日志配置', '1529769783', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('789', '1', 'Demo', 'test', '未设置日志配置', '1529769798', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('790', '1', 'Demo', 'test', '未设置日志配置', '1529769846', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('791', '1', 'Index', 'index', '未设置日志配置', '1529913279', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('792', '1', 'Main', 'index', '未设置日志配置', '1529913280', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('793', '1', 'Demo', 'form', '未设置日志配置', '1529913286', '127.0.0.1', null, null, '0', 'access');
INSERT INTO `bangbang_user_handle_log` VALUES ('794', '1', 'Demo', 'formmodel', '未设置日志配置', '1529913290', '127.0.0.1', null, null, '0', 'access');
